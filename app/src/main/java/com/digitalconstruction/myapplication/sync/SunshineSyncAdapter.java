package com.digitalconstruction.myapplication.sync;
...
import com.digitalconstruction.myapplication.MainActivity;
import com.digitalconstruction.myapplication.R;
import com.digitalconstruction.myapplication.Utility;
import com.digitalconstruction.myapplication.data.WeatherContract;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Log.v(LOG_TAG, "inserting " + cityName + ", with coord: " + lat + ", " + lon + ". " + locationSetting);
